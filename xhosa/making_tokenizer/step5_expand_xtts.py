...
config_path = "/home/eleven/africa_voiceModels/alltalk_tts/models/xtts/xttsv2_2.0.3/config.json"                        # Path to the base model config.json
pretrained_model_path = "/home/eleven/africa_voiceModels/alltalk_tts/models/xtts/xttsv2_2.0.3/original_model.pth"                # Path to the base model.pth
new_tokenizer_path = "/home/eleven/africa_voiceModels/Client_JRolo/xhosa/dataset_files/Combined_1_2/xhosa_merged_vocab_tokenizer_6_25.json"                               # Path to the new combined expanded_vocab.json
expanded_model_path = "/home/eleven/africa_voiceModels/Client_JRolo/xhosa/dataset_files/Combined_1_2/xhosa_expanded_model_6_25.pth"                               # Path to where you want the new expanded_model.pth
